...
legend("topleft", legend=c("point",  "E[y|theta]", "regression")) 
```
### Question 7
...
y = y[y > 1.99 & y < 2.01]
plot(y, theta)
hist(theta, proba = TRUE)

x_theo = seq(-10, 14,length.out =  100)
y_theo = dnorm(x_theo, 4, 4)
lines(x_theo, y_theo, col = "green")
print(mean(theta))
```
